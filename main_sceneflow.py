...
parser = argparse.ArgumentParser(description='MMB-Stereo: Mamba-based Multi-branch Cost Aggregation')
...
parser.add_argument('--datapath', default="/root/autodl-tmp/sceneflow/", help='SceneFlow data path')
...
parser.add_argument('--lrepochs',default="8,11,14,17,20,23,25,27,29,30:2", type=str, help='learning rate decay epochs and rate')

parser.add_argument('--logdir', default='./runs/sceneflow/MMB-Stereo', help='directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default='', help='load weights from specific checkpoint')
parser.add_argument('--resume', action='store_true', help='continue training from latest checkpoint')
parser.add_argument('--seed', type=int, default=1, help='random seed')
parser.add_argument('--summary_freq', type=int, default=100, help='frequency of saving summary')
